...
const LieuAppartementNuit = ({ onClose, onChange }) => {
	...
	const arrivalAppartementNuit = useRef(
		sessionStorage.getItem("arrival_appartement_nuit"),
	);
	...
	useEffect(
		() => MarzipanoInit(panoRef, viewerRef, data, "appartement-nuit"),
		[],
	);
			...
			<div id="fouille" className="single-scene">
				...
				<div className="img" id="img-see1" style={{ display: "none" }}>
					...
					<img
						...
						}fouilles/appartement-nuit/assets/masque-1.png`}
						className="img-see"
					/>
				</div>
				<div className="img" id="img-see2" style={{ display: "none" }}>
					...
					<img
						src={`${
							import.meta.env.BASE_URL
						}fouilles/appartement-nuit/assets/masque-2.png`}
						className="img-see"
					/>
				</div>
				<div className="img" id="img-see3" style={{ display: "none" }}>
					...
					<img
						src={`${
							import.meta.env.BASE_URL
						}fouilles/appartement-nuit/assets/masque-3.png`}
						className="img-see"
					/>
				</div>
				<div className="img" id="img-see4" style={{ display: "none" }}>
					...
					<img
						src={`${
							import.meta.env.BASE_URL
						}fouilles/appartement-nuit/assets/masque-4.png`}
						className="img-see"
					/>
				</div>
				...
				<audio id="arrival" controls style={{ display: "none" }}>
					<source
						src={`${
							import.meta.env.BASE_URL
						}fouilles/appartement-nuit/assets/arrival.mp3`}
						type="audio/mpeg"
					/>
