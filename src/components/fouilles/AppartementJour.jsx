...
const LieuAppartementJour = ({ onClose, onChange }) => {
  ...
  const { actionToggleDataHistory, actionToggleDataObjectif, actionToggleDataEvent } = useContext(DataContext)
    ...
    >
      ...
      >
        ...
        <div className='img' id='img-see1' style={{ display: 'none' }}>
          ...
          <img src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/masque-1.png`} className='img-see' />
        </div>
        <div className='img' id='img-see2' style={{ display: 'none' }}>
          <span className='close-img'>X</span>
          <img src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/masque-2.png`} className='img-see' />
        </div>
        <div className='img' id='img-see3' style={{ display: 'none' }}>
          <span className='close-img'>X</span>
          <img src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/masque-3.png`} className='img-see' />
        </div>
        <div className='img' id='img-see4' style={{ display: 'none' }}>
          <span className='close-img'>X</span>
          <img src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/masque-4.png`} className='img-see' />
        </div>
        <div className='img' id='img-see5' style={{ display: 'none' }}>
          <span className='close-img'>X</span>
          <img src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/money.png`} className='img-see' />
        </div>

        <audio id='board' controls style={{ display: 'none' }}>
          <source src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/board.mp3`} type='audio/mpeg' />
          Your browser does not support the audio element.
        </audio>

        <audio id='money' controls style={{ display: 'none' }}>
          <source src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/money.mp3`} type='audio/mpeg' />
          Your browser does not support the audio element.
        </audio>

        <audio id='animals' controls style={{ display: 'none' }}>
          <source src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/animals.mp3`} type='audio/mpeg' />
          Your browser does not support the audio element.
        </audio>
      ...
      <div id='coffre' style={{ display: 'none' }}>
        <div style={{ position:'relative' }}>
          <img
            id='malle'
            src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/coffre.png`}
            style={{
              width: '80%',
              marginLeft: 'auto',
              marginRight: 'auto',
          ...
          >
            ...
            <br />
            <button type='button' className='btn' style={{ color: 'white' }} name='Essayer' id='btn-coffre'>
              Essayer
            </button>
          </div>
        </div>
        ...
        <div style={{ display: 'none' }}>
          <audio id='coffre-click'>
            <source src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/click.mp3`} type='audio/mpeg' />
            Your browser does not support the audio element.
          </audio>
          <audio id='coffre-wrong'>
            <source src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/reset.wav`} type='audio/wav' />
            Your browser does not support the audio element.
          </audio>
          <audio id='malle-mp3'>
            <source
              src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/comment-1.mp3`}
              type='audio/mpeg'
            />
            Your browser does not support the audio element.
          </audio>
      ...
      <div id='coffre-ouvert' style={{ display: 'none' }}>
        <div style={{ position: 'relative' }}>
          <img
            id='malle'
            src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/opened-malle.jpg`}
        ...
        <div style={{ display: 'none' }}>
          <audio
            id='malle-opened'
            src={`${import.meta.env.BASE_URL}fouilles/appartement/assets/opened-malle.mp3`}
            type='audio/mpeg'
          ></audio>
        </div>
        <button
