		...
		return (
			<div className='quizz__instructions'>
				<p className='quizz__instructions__text'>
					...
					<br /> On vous chronomètre, pour tester un peu votre mémoire.
				</p>
				<button type='button' className='quizz__instructions__button button--red' onClick={endInstructions}>
					Commencer
				</button>
			</div>
		)
	...
	const renderQuestion = () => {
		return (
			<div className='quizz__question'>
				...
				<button type='button' className='quizz__question__button button--red' onClick={handleQuestionForm}>
					Valider
				</button>
	...
	const renderAsnwer = () => {
		return (
			<div className='quizz__answer'>
				...
				<button type='button' className='quizz__question__button button--red' onClick={handleAnswerForm}>
					Suivant
				</button>
				<div className='quizz__pagination'>
					<div className='quizz__pagination__tracker'>{renderPagination()}</div>
	...
	const displayResults = () => {
		return (
			<div className='quizz__results'>
				...
				<button type='button' className='quizz__instructions__button button--red' onClick={handleEndQuizz}>
					Reprendre l&apos;enquête
				</button>
			</div>
		)
