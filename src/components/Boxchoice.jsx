		...
		return (
			<div className='modal-boxdone__background'>
				<div className='modal-boxdone__box'>
					<button type='button' className='modal-boxdone__icon--container'>
						<img className='modal-boxdone__icon' src={Cross} onClick={handleModal} alt='' />
					</button>
					{data.id === 3 ? (
						<p className='modal-boxdone__text'>
							Vous avez résolu le mystère du Tueur au Tarot et clos le dossier. <br />
							Rendez-vous sur notre site pour découvrir nos autres enquêtes.
						</p>
					) : (
						<p className='modal-boxdone__text'>
							Vous avez déjà terminé cette partie de l&apos;enquête. <br />
							Passez à la box suivante pour continuer et démasquer le tueur ou rendez-vous sur notre site pour découvrir
							nos autres enquêtes
						</p>
					)}
					<button type='button' className='modal-boxdone__button button--red' onClick={openWebsite}>
